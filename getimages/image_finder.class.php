...
private $size;
		...
		$response = file_get_contents($url);
                ...
                if($response)
                {
						...
						//$document->loadHTML(file_get_contents('https://www.flipkart.com/arrow-sport-printed-men-s-polo-neck-blue-t-shirt/p/itmevxrasxvdxduz?pid=TSHEVXRAQHBCUDDB&srno=b_1_1&otracker=hp_omu_Top%20Offers_3_50-80%25%20Off_15PPXABUQC_0&lid=LSTTSHEVXRAQHBCUDDB6MWQEH&fm=neo/merchandising&iid=d5904953-b4a8-41e9-96b7-78cf2448b534.TSHEVXRAQHBCUDDB.SEARCH'));
                        $document->loadHTML($response);
						//$document = htmlspecialchars(file_get_contents('https://www.flipkart.com/arrow-sport-printed-men-s-polo-neck-blue-t-shirt/p/itmevxrasxvdxduz?pid=TSHEVXRAQHBCUDDB&srno=b_1_1&otracker=hp_omu_Top%20Offers_3_50-80%25%20Off_15PPXABUQC_0&lid=LSTTSHEVXRAQHBCUDDB6MWQEH&fm=neo/merchandising&iid=d5904953-b4a8-41e9-96b7-78cf2448b534.TSHEVXRAQHBCUDDB.SEARCH'));
                        libxml_clear_errors();
                }
