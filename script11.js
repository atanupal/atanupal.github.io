 ...
 if (window.XMLHttpRequest) {
  ...
  xmlhttp.onreadystatechange=function() {
   ...
   div.style.visibility = "hidden"; 
	...
	document.getElementById('postedby1').innerText="";
	...
	document.getElementById('dealprice2').innerText="";
		...
		document.getElementById('img2').innerText="";
		document.getElementById('link2').innerText="";
		document.getElementById('postedby2').innerText="";
	...
	document.getElementById('dealprice3').innerText="";
		...
		document.getElementById('img3').innerText="";
		document.getElementById('link3').innerText="";
		document.getElementById('postedby3').innerText="";
	...
	document.getElementById('dealprice4').innerText="";
		...
		document.getElementById('img4').innerText="";
		document.getElementById('link4').innerText="";
	document.getElementById('postedby4').innerText="";
	...
	document.getElementById('description1').innerText = arr[4].split("([{").join(' ');
	document.getElementById('dealprice1').innerText = arr[5].split("([{").join(' ');
	document.getElementById('maxprice1').innerText= arr[6].split("([{").join(' ');
	document.getElementById('img1').innerText= arr[7].split("([{").join(' ');
	document.getElementById('link1').innerText = arr[8].split("([{").join(' ');
	
	document.getElementById("link1").setAttribute("onclick", "location.href='" + arr[9].split("([{").join(' ') + "'");
...
document.getElementById('postedby1').innerText = arr[12].split("([{").join(' ');

	document.getElementById('deal_id2').innerText = arr[14].split("([{").join(' ');
	document.getElementById('summary2').innerText = arr[15].split("([{").join(' ');
	document.getElementById('description2').innerText = arr[16].split("([{").join(' ');
	document.getElementById('dealprice2').innerText= arr[17].split("([{").join(' ');
		...
		document.getElementById('img2').innerText= arr[19].split("([{").join(' ');
		document.getElementById('link2').innerText = arr[20].split("([{").join(' ');
		document.getElementById("link2").setAttribute("onclick", "location.href='" + arr[21].split("([{").join(' ') + "'");
    ...
    arr[21].split("([{").join(' ') 
	  ...
	  document.getElementById('postedby2').innerText = arr[24].split("([{").join(' ');
	  
	document.getElementById('deal_id3').innerText = arr[27].split("([{").join(' ');
	document.getElementById('summary3').innerText = arr[28].split("([{").join(' ');
	document.getElementById('description3').innerText = arr[29].split("([{").join(' ');
	document.getElementById('dealprice3').innerText = arr[30].split("([{").join(' ');
		...
		document.getElementById('img3').innerText= arr[32].split("([{").join(' ');
		document.getElementById('link3').innerText = arr[33].split("([{").join(' ');
		document.getElementById("link3").setAttribute("onclick", "location.href='" + arr[34].split("([{").join(' ') + "'");
    ...
    arr[34].split("([{").join(' ')
	  ...
	  document.getElementById('postedby3').innerText = arr[37].split("([{").join(' ');
	  
		
	document.getElementById('deal_id4').innerText = arr[39].split("([{").join(' ');
	document.getElementById('summary4').innerText = arr[40].split("([{").join(' ');
	document.getElementById('description4').innerText = arr[41].split("([{").join(' ');
	document.getElementById('dealprice4').innerText = arr[42].split("([{").join(' ');
		document.getElementById('maxprice4').innerText = arr[43].split("([{").join(' ');
		document.getElementById('img4').innerText= arr[44].split("([{").join(' ');
		document.getElementById('link4').innerText = arr[45].split("([{").join(' ');
	document.getElementById("link4").setAttribute("onclick", "location.href='" + arr[46].split("([{").join(' ') + "'");
	...
	document.getElementById('postedby4').innerText = arr[49].split("([{").join(' ');
