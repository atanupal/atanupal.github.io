...
var first = document.getElementById('first').value;
	...
	input_val = input_val.split(" ").join("%20");


	var inputtype = document.getElementById('inputtype').value;
	var inputtype_val = document.getElementById('inputtype_val').value;
	...
	if (formatted_address == "yes")
	{
		str=str+"formatted_address,";
	}
	else
	{
		str=str;
	...
	if (opening_hours == "yes")
	{
		str=str+"opening_hours,";
	}
	else
	{
		str=str;
	...
	document.getElementById('input1').value=first + input + "=" + input_val + "&" + inputtype + "=" + inputtype_val + "&" + "fields=" +str + "&key=AIzaSyAOcYiQnfU6apPKQR3CZuk0mR0yqriaWpg";
	var input1=document.getElementById('input1').value;


var url="https://maps.googleapis.com/maps/api/place/findplacefromtext/json?input=Museum%20of%20Contemporary%20Art%20Australia&inputtype=textquery&fields=photos,formatted_address,name,rating,opening_hours,geometry&key=AIzaSyAOcYiQnfU6apPKQR3CZuk0mR0yqriaWpg";

var url2= "https://ipinfo.io/json";
...
xhr.onreadystatechange = processRequest;
	...
	alert(response);
		...
		document.getElementById('input1').value="temp";	
...
//for (j=j; j<18 ; j++)
	...
	//	
	//}	
	document.getElementById('output1').value=arr[0];		
	...
	document.getElementById('p32').value=arr[31];
		...
		document.getElementById('p33').value=arr[32];
			...
			document.getElementById('p34').value=arr[33];
				document.getElementById('img35').src=arr2[34];
				document.getElementById('p35').value=arr2[34];
					document.getElementById('img36').src=arr2[35];
					document.getElementById('p36').value=arr2[35];
						document.getElementById('img37').src=arr2[36];
						document.getElementById('p37').value=arr2[36];
