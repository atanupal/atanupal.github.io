...
function geturl()
{
 ...
 if (window.XMLHttpRequest) {
  ...
  xmlhttp.onreadystatechange=function() {
	...
	document.getElementById('img1').src=arr[6];
	document.getElementById('img2').src=arr[7];
	document.getElementById('img3').src=arr[8];
	document.getElementById('img4').src=arr[9];
	document.getElementById('img5').src=arr[10];
	document.getElementById('img6').src=arr[11];
