...
function upload()
{
	...
	var link2 = document.getElementById('url').value;
	var picturelink = arr[tem];
	
alert ("http://atanupal.gearhostpreview.com/ins.php?summary=\"" + summary + "\"&description=\"" + description + "\"&dealprice=\"" + dealprice + "\"&maxprice=\"" + maxprice + "\"&link=\"" + link2 + "\"&picturelink=\"" + picturelink + "\"");
 ...
 if (window.XMLHttpRequest) {
  ...
  xmlhttp.open("GET","http://atanupal.gearhostpreview.com/ins.php?summary=\"" + summary + "\"&description=\"" + description + "\"&dealprice=\"" + dealprice + "\"&maxprice=\"" + maxprice + "\"&link=\"" + link2 + "\"&picturelink=\"" + picturelink + "\"",true);
  xmlhttp.send();
...
alert ("summary=\"" + summary + "\"&description=\"" + description + "\"&dealprice=\"" + dealprice + "\"&maxprice=\"" + maxprice + "\"&link=\"" + link2 + "\"&picturelink=\"" + picturelink + "\"");
	alert(link2);
