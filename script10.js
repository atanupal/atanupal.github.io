 ...
 if (window.XMLHttpRequest) {
  ...
  xmlhttp.onreadystatechange=function() {
   ...
   div.style.visibility = "hidden"; 
	...
	document.getElementById('posted1').innerText="";
	...
	document.getElementById('dealprice2').innerText="";
		...
		document.getElementById('posted2').innerText="";
	...
	document.getElementById('dealprice3').innerText="";
		...
		document.getElementById('posted3').innerText="";
	...
	document.getElementById('posted4').innerText="";
...
document.getElementById('posted1').innerText = arr[12].split("([{").join(' ');
	...
	document.getElementById('dealprice2').innerText= arr[17].split("([{").join(' ');
		...
		document.getElementById("link2").setAttribute("onclick", "location.href='" + arr[19].split("([{").join(' ') + "'");
    ...
    arr[19].split("([{").join(' ') 
	  ...
	  document.getElementById('posted2').innerText = arr[25].split("([{").join(' ');
	...
	document.getElementById('dealprice3').innerText = arr[30].split("([{").join(' ');
		...
		document.getElementById("link3").setAttribute("onclick", "location.href='" + arr[32].split("([{").join(' ') + "'");
    ...
    arr[32].split("([{").join(' ')
	  ...
	  document.getElementById('posted3').innerText = arr[38].split("([{").join(' ');
	...
	document.getElementById("link4").setAttribute("onclick", "location.href='" + arr[45].split("([{").join(' ') + "'");
	...
	document.getElementById('posted4').innerText = arr[51].split("([{").join(' ');
