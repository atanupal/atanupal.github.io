...
alert ("http://atanupal.gearhostpreview.com/ins.php?summary=\"" + summary + "\"&description=\"" + description + "\"&dealprice=\"" + dealprice + "\"&maxprice=\"" + maxprice + "\"&link=\"" + url + "\"&picturelink=\"" + picturelink + "\"");
 ...
 if (window.XMLHttpRequest) {
  ...
  xmlhttp.open("GET","http://atanupal.gearhostpreview.com/ins.php?summary=\"" + summary + "\"&description=\"" + description + "\"&dealprice=\"" + dealprice + "\"&maxprice=\"" + maxprice + "\"&link=\"" + url + "\"&picturelink=\"" + picturelink + "\"",true);
  xmlhttp.send();
