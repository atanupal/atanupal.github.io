...
var stemp= document.cookie.indexOf('spageno=');

if (stemp==-1)
{
document.cookie = 'spageno=1';
var spageno = getCookie("spageno");

document.cookie = 'sposition=0';
var sposition=getCookie("sposition");

document.cookie = 'scount=0';
var scount=getCookie("scount");

document.cookie = 'spage=1';
var spage = getCookie("spage");
...
function getcurrent()
{
sposition=getCookie("sposition");


  document.getElementById("scurrent").innerHTML = sposition;
...
document.cookie = 'spageno=1';
 spageno = getCookie("spageno");
  spage = getCookie("spage");
 //document.getElementById("spage_number").innerHTML = "Page Number is : " + spageno;

 document.getElementById("spage_number").innerHTML = "Page " + spageno + " of " + spage;
 

document.cookie = 'sposition=0';
 sposition=getCookie("sposition");
 document.getElementById('scurrent').innerHTML=0;

document.cookie = 'scount=0';
 scount=getCookie("scount");
document.getElementById('scount').innerHTML="Number of deals are " + 0;
...
//document.cookie = 'spage=1';
 spage = getCookie("spage");
//document.getElementById('snumber_of_pages').innerHTML= "Number of Pages are " + 1;
...
getcount();
 ...
 if (window.XMLHttpRequest) {
  ...
  xmlhttp.onreadystatechange=function() {
   ...
   var div= document.getElementById("stxtHint");
   div.style.visibility = "hidden"; 
      document.getElementById("stxtHint").innerHTML="";
...
//alert( "U1 " + u1 + " u2 " + u2 + " u3 " + u3 + " u4 " + u4 + " d1 " + d1 + " d2 " + d2 + " d3 " + d3 + " d4 " + d4);
...
if (vare1=='1') {
  ...
  xmlhttp.open("GET","http://atanupal.gearhostpreview.com/search.php?argument1=" + sposition + "&type=" + searchtype + "&strd=" + str,true);
  xmlhttp.send();
...
div= document.getElementById("scurrent");
   div.style.visibility = "hidden"; 
	
	  div= document.getElementById("snumber_of_pages");
   div.style.visibility = "hidden"; 
...
spageno=getCookie("spageno");
 ...
 if (window.XMLHttpRequest) {
  ...
  xmlhttp.onreadystatechange=function() {
       ...
       document.getElementById("scount").innerHTML = "Number of deals are " + JSON.parse(this.responseText);
	   
	   

	   
    
	document.cookie = 'scount='+ JSON.parse(this.responseText); 
	scount=getCookie("scount");
	...
	var moddd = scount%4;
	  ...
	  if (moddd == 0)
	   {
	   document.cookie='spage='+(scount/4); 
	   spage = scount/4;
	
	   
	 //  document.getElementById("snumber_of_pages").innerHTML = "Number of Pages are " + spage;
	   
 document.getElementById("spage_number").innerHTML = "Page " + spageno + " of " + spage;
	   }
	   else
	   {
	   document.cookie='spage='+Math.ceil(scount/4);
		spage = Math.ceil(scount/4);
 ...
 else
 {
  ...
  xmlhttp.open("GET","http://atanupal.gearhostpreview.com/numberofsearch.php?type=" + searchtype + "&strd=" + str,true);
  xmlhttp.send();
...
if (sposition < parseInt(scount)-4-parseInt(modd))
{

sposition = getCookie("sposition");
sposition = parseInt(sposition) + 4;

document.cookie = 'sposition=' + sposition ;
sposition = getCookie("sposition");
spageno=getCookie("spageno");
spageno=parseInt(spageno) + 1;

document.cookie = 'spageno='+(spageno);
spageno = getCookie("spageno");
 spage = getCookie("spage");
//document.getElementById("spage_number").innerHTML = "Page Number is : " + spageno;
...
sposition=getCookie("sposition");
spageno=getCookie("spageno");
spageno=parseInt(spageno) - parseInt(1);
